...
//  pengujian yang memeriksa kasus negative untuk fungsi tambah dan kali .


//   it('seharusnya mengembalikan NaN saat menambahkan 2 + 3', function() {
//     expect(tambah(2, '3')).to.equal(null);
//   });

    it('seharusnya mengembalikan NaN saat menambahkan null dengan null', function() {
        expect(tambah(null, null)).to.NaN(null);
 });
});
